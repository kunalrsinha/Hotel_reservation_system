export default function RoomCard({ room }) {
  ...
  return (
    <div
      ...
      className={`flex aspect-square min-h-12 w-12 shrink-0 items-center justify-center rounded-lg border text-sm font-bold shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:scale-105 hover:shadow-md sm:w-14 ${statusClasses}`}
    >
      {room.id}
    </div>
  );
